...
const screenChecks = [
  ...
  },
  {
    ...
    expected: [
      ...
      "Reply from",
      "unread",
      "Alice mentioned you in a public thread",
      "Alice replied and may need a response",
      "Related post",
      "What this is about",
      "Original Dais post with context for the notification",
      "A post that was liked by Alice",
      "Like from",
      "Open context",
      'data-actor-feed="https://mastodon.example/users/alice"',
