...
| Status reads | `GET /api/v1/statuses/:id`, `GET /api/v1/statuses/:id/context` | Implemented |
...
- Poll creation remains unsupported until dais has first-class poll storage and
  ActivityPub `Question` support wired into owner workflows.
