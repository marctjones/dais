...
<body>
    ...
    <div class="footer">
        <p>Open source under active development. Running on Cloudflare Workers, D1, R2, and Queues. Homepage status updated after the 2026-07-08 strict production/skpt server release gate.</p>
    </div>
</body>
</html>"#,
        domain = domain,
